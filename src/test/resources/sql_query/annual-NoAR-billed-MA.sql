select
ver.agr_id, ver.bil_ctm, cvi.auth_val as "ucc_id", apt.srv_typ, eml.adr_eml, ver.VER_STRT
...
where ver.srv_prd like 'y%' and ver.agr_ren = 'y' and sts.agr_sts = 'a' and sts.abil_sts = 'b' and sts.aexp_dte = sts.afin_exp and adr.cun_typ = '' and adr.ctm_ste = 'MA' and apt.srv_typ = 'catj-ind';