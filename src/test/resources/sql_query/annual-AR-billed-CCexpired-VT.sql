...
where ver.srv_prd like 'y%' and ver.agr_ren = 'a' and ver.pmo_cde like '@%' and sts.agr_sts = 'a' and sts.abil_sts = 'b' and sts.aexp_dte = sts.afin_exp and adr.cun_typ = '' and adr.ctm_ste = 'vt' and apt.srv_typ = 'catj-ind';
