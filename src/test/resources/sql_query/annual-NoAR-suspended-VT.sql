...
where ver.srv_prd like 'y%' and ver.agr_ren = 'y' and sts.agr_sts = 'b' and sts.abil_sts = 'b' and sts.aexp_dte = sts.afin_exp and apt.srv_typ = 'catj-ind'and adr.cun_typ = '' and adr.ctm_ste = 'VT';
