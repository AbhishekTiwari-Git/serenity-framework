...
where ver.srv_prd like 'y%' and ver.agr_ren = 'y' and sts.agr_sts = 'a' and sts.abil_sts = 'p' and sts.aexp_dte <> sts.afin_exp and fut.agr_ren = 'y' and fut.abil_sts <> 'p' and apt.srv_typ = 'catj-ind';
