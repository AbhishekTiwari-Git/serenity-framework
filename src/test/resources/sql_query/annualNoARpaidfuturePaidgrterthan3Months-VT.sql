select
ver.agr_id, ver.bil_ctm, cvi.auth_val as "ucc_id", apt.srv_typ, eml.adr_eml
...
where (ver.srv_prd like 'y%' and ver.agr_ren = 'y' and sts.agr_sts = 'a' and sts.abil_sts = 'p' and sts.aexp_dte <> sts.afin_exp and fut.agr_ren = 'y' and fut.abil_sts = 'p' and datediff(month,getdate(),sts.afin_exp) > 3) and
apt.srv_typ = 'catj-ind' and adr.cun_typ = '' and adr.ctm_ste = 'VT';
